...
function DroneModel(props: any) {
  ...
  const { scene, animations } = useGLTF("/assets/js/threejs/models/MikasDrone.gltf");
  ...
  scene.traverse((child) => {
    if ((child as Mesh).isMesh) {
      ...
      if (meshIndex === 3 || meshIndex === 4 || meshIndex === 5 || meshIndex === 1) {
  ...
  return <primitive ref={group} object={scene} scale={0.04} position={[0, -2, 0]} {...props} />;
}

export default function Drones3D() {
  return (
