...
const PROJECTS: { [section: string]: Project[] } = {
  ...
  "Node Projects": [
    ...
    { title: "LLM Rules Manager", description: "Manage orthography, context, and tool usage rules for AI assistants", href: "/llm-rules", accentColor: "168, 85, 247" },
    ...
    { title: "Video Dubbing", description: "AI voice dubbing for YouTube videos — translate to French or Portuguese", href: "/video-dubbing", accentColor: "168, 85, 247", isPublic: true },
